...
// Summary: This class acts as the controller for the modify product fxml file.
public class ModifyProduct
{
    ...
    @FXML
    void cancelSelectedProductModifications()
    {
    ...
    //      data, as well as populate the text entry fields with the instance variable data from the selected product
    void populateData(Product product, ObservableList<Part> allParts)
    {
        // Set the product ID to the given product's ID (a new unique ID value is not necessary) and fill in each text
        // entry field with the respective values
        this.id = product.getId();
        this.productNameTextField.setText(product.getName());
        this.productPriceTextField.setText(Double.toString(product.getPrice()));
        this.productInventoryTextField.setText(Integer.toString(product.getStock()));
        this.productMinTextField.setText(Integer.toString(product.getMin()));
        this.productMaxTextField.setText(Integer.toString(product.getMax()));
        ...
        // Populate the list of associated parts and the table view of associated parts with the asssociated parts list
    ...
    // Getters and setters
    Product getModifiedProduct() { return this.newProduct; }
}
